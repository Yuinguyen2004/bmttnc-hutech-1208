...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.btn_encrypt.setGeometry(QtCore.QRect(110, 460, 75, 23))
        self.btn_encrypt.setAutoFillBackground(False)
        self.btn_encrypt.setObjectName("btn_encrypt")
        self.btn_decrypt = QtWidgets.QPushButton(self.centralwidget)
        self.btn_decrypt.setGeometry(QtCore.QRect(600, 460, 75, 23))
        self.btn_decrypt.setAutoFillBackground(False)
        self.btn_decrypt.setObjectName("btn_decrypt")
        self.label_4 = QtWidgets.QLabel(self.centralwidget)
        self.label_4.setGeometry(QtCore.QRect(240, 20, 261, 31))
        font = QtGui.QFont()
        ...
        self.btn_create_matrix.setGeometry(QtCore.QRect(350, 460, 75, 23))
        self.btn_create_matrix.setAutoFillBackground(False)
        self.btn_create_matrix.setObjectName("btn_create_matrix")
        self.txt_matrix = QtWidgets.QPlainTextEdit(self.centralwidget)
        self.txt_matrix.setGeometry(QtCore.QRect(220, 340, 361, 71))
        self.txt_matrix.setObjectName("txt_matrix")
        self.label_5 = QtWidgets.QLabel(self.centralwidget)
        self.label_5.setGeometry(QtCore.QRect(170, 370, 41, 16))
